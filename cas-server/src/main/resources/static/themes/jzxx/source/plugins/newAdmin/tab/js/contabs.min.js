$(function () {
    ...
    function c() {
                ...
                if (!$(this).hasClass("active")) {
                    ...
                    $(".J_mainContent .J_iframe").each(function () {
                        if ($(this).data("id") == o) {
                            ...
                            fixChromeScroll($(this).show().siblings(".J_iframe"));
                            return false
                        }
                    })
                }
        ...
        if (k) {
            var p = '<a href="javascript:;" class="active J_menuTab" indexId="'+m+'" idBu ="'+idBu+'" rootId="'+rootId+'" data-id="' + o + '">' + l + ' <i class="iconfont icon-cuowu"></i></a>';
            $(".J_menuTab").removeClass("active");
            var n = '<iframe scrolling="auto" class="J_iframe" id="iframe' + m + '" indexId="'+m+'" idBu ="'+idBu+'" rootId="'+rootId+'" name="iframe' + m + '" width="100%" height="100%" src="' + o + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
            $(".J_mainContent").find("iframe.J_iframe").hide().parents(".J_mainContent").append(n);
            $(".J_menuTabs .page-tabs-content").append(p);
            g($(".J_menuTab.active"))
            //loadXtIframeComplete(m,dt1,l);//加载页面监控;
            
        }
        return false
    }
    //$(".J_menuItem").on("click", c);
    $(this).on('click',".J_menuItem", c);
...
//        	console.info($(this).data("data-id]"));
            $('.J_iframe[data-id="' + $(this).data("id") + '"]').remove();
            tabIdList.push($(this).data("indexId"));//放入所有TabIdList
            $(this).remove()
        });
        cleanActive(tabIdList);//清空样式
...
function cleanActive(tabIdList){
...
function fixChromeScroll(iframs){
    try{
    	var id = iframs.context.id;
