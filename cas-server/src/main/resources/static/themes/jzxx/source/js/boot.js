...
function callLang(){
    var lang = {
        ...
        "sInfo":"正在显示第 _START_ 至 _END_ 项结果，共 _TOTAL_ 项",
        "sInfoEmtpy":"找不到相关数据",
...
//    			"bScrollCollapse":true,
            dom:settings.dom != null?settings.dom:"<\"row \"<\"col-12\"l>>t<\"row\"<\"col-sm-12 col-md-5\"i><\"col-sm-12 col-md-7\"p>>",
           //dom:"<\"row \"<\"col-12\"l>>t<\"row\"<\"col-sm-12 col-md-5\"i><\"col-sm-12 col-md-7\"p>>",
//             "bFilter":false,//搜索栏
...
//             "orderMulti":false,//启用多列排序
            ...
            // "sPaginationType":"full_numbers",//分页，一共两种样式，full_numbers和two_button(默认)
             "aLengthMenu":[15, 30, 50, 100, 500 ],//设置每页显示记录的下拉菜单也可以设置为pageList
...
function getProvice(num){
    ...
    $.ajax({
        type:"POST",
        url:basePath+"/xtAreaRegionController/getPList",
        dataType:"JSON",
        async:false,
        xhrFields:{withCredentials:true},
...
function getCity(num){
    ...
    $.ajax({
        type:"POST",
        url:basePath+"/xtAreaRegionController/getCList",
...
function getCounties(num){
    ...
    $.ajax({
        type:"POST",
        url:basePath+"/xtAreaRegionController/getDList",
...
//	var xt_data_dictionary_name="∨";
    $.ajax({
        type:"GET",
        xhrFields:{withCredentials:true},
        url:basePath+"/xtDataDictionaryController/getXtDataDictionaryById",
...
function InitBDataComboCallFn(ckey,fn){
    $.ajax({
        type:"GET",
        xhrFields:{withCredentials:true},
        url:basePath+"/xtCommonController/getXtDataDictionaryList",
        data:"ckey="+ckey,
        success: function(result){
            fn(result);
        }
 ...
 * id 下拉框id
 */
function InitBDataComboVal(ckey,id){
    var str = "<option value=''>请选择</option>";
    $.ajax({
        type:"GET",
        url:basePath+"/xtCommonController/getXtDataDictionaryList",
...
//		   result.xt_data_dictionary_name;
            //从服务器获取数据进行绑定
            $.each(data, function(i, item){
                str += "<option value=" + item.xt_data_dictionary_value + ">" + item.xt_data_dictionary_name + "</option>";
            })
            $("#"+id).append(str);
        }
    });
 ...
 * value_id 下拉框对应的值
 */
function InitBDataComboValSetV(ckey,id,value_id){
    var str = "<option value=''>请选择</option>";
    $.ajax({
        type:"GET",
        url:basePath+"/xtCommonController/getXtDataDictionaryList",
...
function InitconstantList(ckey,id){
    ...
    $.ajax({
        type:"GET",
        xhrFields:{withCredentials:true},
        url:basePath+"/xtConstantController/getXtConstantList",
